...
class WindowsOsTrustStore : OsTrustStore {
    ...
    override fun uninstall() = runOsTrustStoreProcess("certutil", "-user", "-delstore", "Root", "localhost")
}
...
class MacOsTrustStore : OsTrustStore {
    ...
    override fun uninstall() = runOsTrustStoreProcess("security", "delete-certificate", "-c", "localhost")
}
